...
static int cmp_public_key_values(P11PROV_OBJ *pub_key1, P11PROV_OBJ *pub_key2)
{
    ...
    case CKK_RSA:
         ...
         */
        ret = cmp_attr(pub_key1, pub_key2, CKA_MODULUS) & cmp_attr(pub_key1, pub_key2, CKA_PUBLIC_EXPONENT);
        break;
    case CKK_EC:
    case CKK_EC_EDWARDS:
...
static int match_public_keys(P11PROV_OBJ *key1, P11PROV_OBJ *key2)
{
    ...
    if ((key1->class == CKO_PUBLIC_KEY && key2->class == CKO_PUBLIC_KEY) || key1->data.key.type == CKK_RSA) {
